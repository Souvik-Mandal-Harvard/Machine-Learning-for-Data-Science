...
2. **Work through `00_Regression/`.** Start with its [workflow guide](00_Regression/Guide00_Supervised-ML_Linear_Regression_end-to-end_workflow.md), then do notebooks `Guide01` to `Guide05` in order. See the [regression README](00_Regression/README.md) for the notebook list and datasets.
...
| `00_Regression/` | Linear regression: a basic workflow guide, notebooks `Guide01`–`Guide05`, and the `data/` folder. |
